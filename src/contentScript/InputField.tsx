...
<div class="learnip-container-div-23" >
    <input class='learnip-input-23' type="text" placeholder="Translate"> </input><span class='learnip-country-img-23'  >${flags[country]}</span>
    <button class="learnip-translate-button-23">
       ${defaultCheck}
    </button>
</div>
`;
