...
const InputField = (country: string, className: string) => `
<div id="learnip-container-div-23" class="${className}" >
    <input autocomplete="off"  id='learnip-input-23' type="text" placeholder="Translate"> </input><span id='learnip-country-img-23'  >${flags[country]}</span>
    <button id="learnip-translate-button-23">
       ${defaultCheck}
    </button>
</div>
`;
