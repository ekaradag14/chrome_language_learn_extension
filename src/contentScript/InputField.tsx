...
const InputField = (country: string) => `
<div class="extra-chrome-gift" >
    <input class='ern-ext-input' type="text" placeholder="Translate"> </input><span class='count-img' ' >${flags[country]}</span>
